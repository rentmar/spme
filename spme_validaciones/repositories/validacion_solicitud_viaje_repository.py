# spme/spme_validaciones/repositories/validacion_solicitud_viaje_repository.py
from .base_repository import BaseValidacionRepository
from ..models import ValidacionSolicitudViaje
from django.utils import timezone
from datetime import timedelta

class ValidacionSolicitudViajeRepository(BaseValidacionRepository):
    """
    Repositorio para ValidacionSolicitudViaje.
    """
    def __init__(self):
        super().__init__(ValidacionSolicitudViaje)
