...
class ValidacionSolicitudPagoDirectoRepository(BaseValidacionRepository):
    """
    Repositorio para ValidacionSolicitudPagoDirecto.
    """
    def __init__(self):
        super().__init__(ValidacionSolicitudPagoDirecto)
