...
from ..models import ValidacionSolicitudPagoDirecto

# Serializers

from ..serializers.validaciones_solicitud_pago_directo_serializers import (
    ValidacionSolicitudPagoDirectoSerializer,
    AsignarValidadoresSolicitudPagoDirectoSerializer,
    ResetearValidacionesSolicitudPagoDirectoSerializer,
)

# Services
from ..services.validacion_solicitud_pago_directo_service import ValidacionSolicitudPagoDirectoService

# Repositories
from ..repositories.validacion_solicitud_pago_directo_repository import ValidacionSolicitudPagoDirectoRepository
...
# ASIGNAR VALIDADORES
# ===================================================================
class AsignarValidadoresSolicitudPagoDirectoViewSet(viewsets.ViewSet):
    """
    POST /api/solicitud-pago-directo/{id}/asignar-validadores/ 
    ...
    def create(self, request, solicitud_id=None):
        serializer = AsignarValidadoresSolicitudPagoDirectoSerializer(data=request.data)
        if not serializer.is_valid():
            return Response(serializer.errors, status=status.HTTP_400_BAD_REQUEST)
        
        solicitud = get_object_or_404(SolicitudPagoDirecto, id=solicitud_id)
        ...
        for validador in validadores:
            try:
                ...
                resultados.append(ValidacionSolicitudPagoDirectoSerializer(v).data)
        ...
        if validadores_json:
            ...
            for val in validadores:
                encolar_validacion_pendiente_sf(
                    solicitud=solicitud,
                    validador=val,
                    enlace_ver_detalle=f"/solicitudes-pago-directo/{solicitud.id}/validar"
                )
        return Response({
...
# EMITIR VOTO
# ===================================================================
class VotarSolicitudPagoDirectoViewSet(viewsets.ViewSet):
    """
    POST /api/solicitud-pago-directo/{solicitud_id}/votar/
    ...
    def create(self, request, solicitud_id=None):
        ...
        try:
            validacion = ValidacionSolicitudPagoDirecto.objects.get(
                id=validacion_id,
                usuarioValidador=request.user,
                estado='PENDIENTE'
            )
        except ValidacionSolicitudPagoDirecto.DoesNotExist:
            return Response(
        ...
        if voto == 'APROBADO':
            ...
            if resumen['aprobado_totalmente']:
                validaciones_aprobadas = ValidacionSolicitudPagoDirecto.objects.filter(
        ...
        return Response(
            ValidacionSolicitudPagoDirectoSerializer(validacion).data,
...
# ===================================================================
class ResetearValidacionesSolicitudPagoDirectoViewSet(viewsets.ViewSet):
    """
    POST /api/solicitud-pago-directo/{solicitud_id}/resetear-validaciones/
    ...
    @transaction.atomic
    def create(self, request, solicitud_id=None):
        serializer = ResetearValidacionesSolicitudPagoDirectoSerializer(data=request.data)
        if not serializer.is_valid():
            return Response(serializer.errors, status=status.HTTP_400_BAD_REQUEST)
        solicitud = get_object_or_404(SolicitudPagoDirecto, id=solicitud_id)
        validaciones = ValidacionSolicitudPagoDirecto.objects.filter(solicitud=solicitud)
        ...
        return Response({
            ...
            'documento_numero': solicitud.numeroFormulario or f"SPD-{solicitud.id}",
...
# ===================================================================
class EstadoValidacionSolicitudPagoDirectoAPIView(APIView):
    """
    GET /api/solicitud-pago-directo/{solicitud_id}/estado-validacion/
    """
    permission_classes = [IsAuthenticated]
    ...
    def get(self, request, solicitud_id):
        ...
        return Response({
            ...
            'solicitud_codigo': solicitud.numeroFormulario or f"SPD-{solicitud.id}",
...
# HISTORIAL
# ===================================================================
class HistorialValidacionSolicitudPagoDirectoAPIView(APIView):
    """
    GET /api/solicitud-pago-directo/{solicitud_id}/historial/
    """
    permission_classes = [IsAuthenticated]
    ...
    def get(self, request, solicitud_id):
        ...
        historial = HistorialValidacion.objects.filter(
            validacion__validacionsolicitudpagodirecto__solicitud=solicitud
        ).select_related('usuario', 'validacion__validacionsolicitudpagodirecto').order_by('-fechaCambio')
...
# ===================================================================
class MisValidacionesPendientesSolicitudPagoDirectoAPIView(APIView):
    """
    GET /api/solicitud-pago-directo/mis-pendientes/
    """
    permission_classes = [IsAuthenticated]
    ...
    def get(self, request):
        ...
        for v in pendientes:
            data.append({
                ...
                'solicitud_codigo': v.solicitud.numeroFormulario or f"SPD-{v.solicitud.id}",
...
# ===================================================================
class AsignarValidadoresSolicitudPagoDirectoSinNotificacionViewSet(viewsets.ViewSet):
    """
    POST /api/solicitud-pago-directo/{solicitud_id}/asignar-validadores-sin-notificacion/
    """
    permission_classes = [IsAuthenticated]
