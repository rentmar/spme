# spme/spme_validaciones/serializers/solicitudes_reembolso_usuario_serializers.py
...
class SolicitudReembolsoUsuarioSerializer(serializers.Serializer):
    # Identificación
    id = serializers.IntegerField()
    ...
    # Datos específicos de Reembolso
...
class SolicitudesReembolsoUsuarioResponseSerializer(serializers.Serializer):
    tipo = serializers.CharField(allow_blank=True)
    total = serializers.IntegerField()
    solicitudes = SolicitudReembolsoUsuarioSerializer(many=True)
