#spme/spme_validaciones/serializers/solicitudes_viaje_usuario_serializers.py
...
class SolicitudViajeUsuarioSerializer(serializers.Serializer):
    # Identificación
    id = serializers.IntegerField()
    ...
    evento = serializers.CharField(allow_blank=True)
    lugarEvento = serializers.CharField(allow_blank=True)
    fechaEvento = serializers.DateField(allow_null=True)
    organizador = serializers.CharField(allow_blank=True)
    institucionesParticipantes = serializers.CharField(allow_blank=True)
    justificacionAsistencia = serializers.CharField(allow_blank=True)
    quienCubreGastos = serializers.CharField(allow_blank=True)
    fondosUnitas = serializers.CharField(allow_blank=True)
    tareasPrevias = serializers.CharField(allow_blank=True)
...
class SolicitudesViajeUsuarioResponseSerializer(serializers.Serializer):
    tipo = serializers.CharField(allow_blank=True)
    total = serializers.IntegerField()
    solicitudes = SolicitudViajeUsuarioSerializer(many=True)
