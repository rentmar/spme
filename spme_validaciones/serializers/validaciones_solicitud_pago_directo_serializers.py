...
class ValidacionSolicitudPagoDirectoSerializer(ValidacionBaseSerializer):
    """Serializer para validaciones de solicitud de pago directo."""
    ...
    class Meta(ValidacionBaseSerializer.Meta):
        model = ValidacionSolicitudPagoDirecto
    ...
    def get_tipo_documento(self, obj):
        return 'SOLICITUD_PAGO_DIRECTO'


class AsignarValidadoresSolicitudPagoDirectoSerializer(serializers.Serializer):
    """Serializer para asignar validadores a una solicitud de pago directo."""
...
class ResetearValidacionesSolicitudPagoDirectoSerializer(serializers.Serializer):
    """Serializer para resetear validaciones de solicitud de pago directo."""
