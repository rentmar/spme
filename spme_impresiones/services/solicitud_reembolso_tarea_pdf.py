# spme_impresiones/pdf_generators/solicitud_reembolso_tarea.py
...
class SolicitudReembolsoTareaPDFGenerator(BasePDFGenerator):
    ...
    def _get_actividad_data(self, obj):
        ...
        return {
            ...
            'nombre_corto': obj.actividad.nombreCorto or "Sin nombre",
        }
    ...
    def _procesar_datos_transferencia(self, obj):
        ...
        try:
            ...
            mapeo_tipos = {'EFEC': 'efectivo', 'TB': 'transferencia', 'CHE': 'cheque'}
    ...
    def _procesar_detalle_fondos(self, obj):
        ...
        try:
            ...
            if isinstance(data_dict, dict):
                if 'items' in data_dict: items = data_dict['items']
            elif isinstance(data_dict, list): items = data_dict
    ...
    def generate_filename(self, obj):
        ...
        if obj.usuario and obj.usuario.nombre:
            ...
            if nombre_parts: nombre_solicitante = nombre_parts[0].lower()
