...
from..serializers.lista_sol_reposicion_por_actividad_pei_serializer import SolicitudReembolsoActPeiSerializer


class SolicitudesReembolsoPorActividadPeiSinTareaView(APIView):
    """
    Endpoint para obtener solicitudes de reembolso 
    por actividad PEI con tarea_id = NULL
    """
    
    def get(self, request, id_actividad_pei):
        """
        GET /api/solicitudes-reembolso/actividad-pei/{id_actividad_pei}/sin-tarea/
        """
        try:
            ...
            queryset = SolicitudReembolsoActPei.objects.filter(
                ...
                'actividad', 'tarea', 'formaPago', 'usuario', 'responsable', 'coordinador'
            )
            ...
            return Response({
                ...
                'solicitudes_reembolso': serializer.data
