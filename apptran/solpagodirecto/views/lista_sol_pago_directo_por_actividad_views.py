...
class SolicitudesPagoDirectoSinTareaPorActividadView(APIView):
    """
    Endpoint para obtener todas las solicitudes de PAGO DIRECTO por idActividad
    FILTRADO: Solo las que tienen tarea_id = NULL
    """
    
    def get(self, request, id_actividad):
        """
        GET /api/actividades/{id_actividad}/solicitudes-pago-directo-sin-tarea/
        """
        try:
            ...
            if pagina and por_pagina.isdigit():
                try:
                    ...
                    # Serializar
                    serializer = SolicitudPagoDirectoSimpleSerializer(
