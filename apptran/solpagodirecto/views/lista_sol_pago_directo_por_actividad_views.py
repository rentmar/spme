...
from ..serializer.lista_sol_pago_directo_por_actividad_serializer import SolicitudPagoDirectoSimpleSerializer
...
class SolicitudesPagoDirectoSinTareaPorActividadView(APIView):
    ...
    def get(self, request, id_actividad):
        ...
        base_stats = SolicitudPagoDirecto.objects.filter(actividad_id=id_actividad, tarea__isnull=True)
        ...
        if pagina and por_pagina.isdigit():
            try:
                ...
                serializer = SolicitudPagoDirectoSimpleSerializer(solicitudes_paginadas, many=True)
        ...
        serializer = SolicitudPagoDirectoSimpleSerializer(queryset, many=True)
