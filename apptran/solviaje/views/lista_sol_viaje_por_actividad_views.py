...
class SolicitudesViajeSinTareaPorActividadView(APIView):
    """
    Endpoint para obtener todas las solicitudes de VIAJE por idActividad
    FILTRADO: Solo las que tienen tarea_id = NULL
    """
    
    def get(self, request, id_actividad):
        """
        GET /api/actividades/{id_actividad}/solicitudes-viaje-sin-tarea/
        """
        try:
            ...
            if pagina and por_pagina.isdigit():
                try:
                    ...
                    # Serializar
                    serializer = SolicitudViajeSimpleSerializer(
