...
from ..serializers.obtener_datos_formulario_pei_serializer import (
    UsuarioSerializer,
    ActividadPeiSerializer,
    ValidadorSerializer
)
...
def obtener_datos_solicitud_fondos_pei(request):
    """
    ...
    try:
        ...
        # Obtener actividad
        try:
            actividad = ActividadPei.objects.get(id=id_actividad)
        ...
        actividad_data = ActividadPeiSerializer(actividad).data
