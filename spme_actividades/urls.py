...
urlpatterns = [
    ...
    path(r'obtenerActividadesGantt/',views.ObtenerActividadesGantt.as_view(), name='obtenerActividadesGantt'),
    ...
    path(r'obtenerDashboardActividad/',views.DashboardActividad.as_view(), name='obtenerDashboardActividad'),
]
