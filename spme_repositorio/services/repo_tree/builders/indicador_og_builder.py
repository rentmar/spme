...
class IndicadorOGRepoBuilder(BaseRepoNodeBuilder):
    """Builder para el nodo Indicador OG."""

    node_type = RepoNodeType.INDICADOR_OG.value
    ...
    def get_ids_by_parent(self, parent_id: int, parent_type: str) -> List[int]:
        ...
        return list(
            IndicadorObjetivoGeneral.objects.filter(
