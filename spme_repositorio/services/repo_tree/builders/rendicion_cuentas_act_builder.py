# spme/spme_repositorio/services/repo_tree/builders/rendicion_cuentas_act_builder.py
...
class RendicionCuentasActRepoBuilder(BaseRepoNodeBuilder):
    """Builder para el nodo Rendición de Cuentas de Actividad."""

    node_type = RepoNodeType.RENDICION_CUENTAS_ACT.value
