# spme/spme_repositorio/services/repo_tree/builders/solicitud_reembolso_act_builder.py
...
class SolicitudReembolsoActRepoBuilder(BaseRepoNodeBuilder):
    """Builder para el nodo Solicitud de Reembolso de Actividad."""

    node_type = RepoNodeType.SOLICITUD_REEMBOLSO_ACT.value
