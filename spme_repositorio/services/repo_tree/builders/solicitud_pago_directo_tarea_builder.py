# spme/spme_repositorio/services/repo_tree/builders/solicitud_pago_directo_tarea_builder.py
...
class SolicitudPagoDirectoTareaRepoBuilder(BaseRepoNodeBuilder):
    """Builder para el nodo Solicitud de Pago Directo de Tarea."""

    node_type = RepoNodeType.SOLICITUD_PAGO_DIRECTO_TAREA.value
