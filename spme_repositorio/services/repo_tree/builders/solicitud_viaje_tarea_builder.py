# spme/spme_repositorio/services/repo_tree/builders/solicitud_viaje_tarea_builder.py
...
class SolicitudViajeTareaRepoBuilder(BaseRepoNodeBuilder):
    """Builder para el nodo Solicitud de Viaje de Tarea."""

    node_type = RepoNodeType.SOLICITUD_VIAJE_TAREA.value
