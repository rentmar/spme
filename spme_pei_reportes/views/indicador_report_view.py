#views/indicador_report_view.py
...
@api_view(['GET'])
def indicador_report_word(request, indicador_id):
    """Endpoint para generar reporte Word desde un indicador."""
    try:
        profundidad = request.GET.get('profundidad', 'completa')
        
        composer = ChainComposer()
        arbol = composer.compose(
            tipo_elemento='indicador',
            elemento_id=indicador_id,
        ...
        filename = generar_filename('indicador', indicador_id)
