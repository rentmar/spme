#serializers/indicador_cualitativo_serializer.py
from typing import Dict
from spme_estructuracion_pei.models import IndicadorPeiCualitativo

class IndicadorCualitativoSerializer:
    """Serializa un IndicadorPeiCualitativo a diccionario."""
    
    def serialize(self, indicador: IndicadorPeiCualitativo) -> Dict:
        return {
            "id": indicador.id,
